...
function ChangeArtworkDataInputComponent(props) {
    const showAsterisk = props.formik.errors[props.name] && props.formik.touched[props.name]
                    ...
                    <Button variant="primary" onClick={
                        (e)=>{
                            ...
                            if(props.formik.error){
                                ...
                                updateArtworkData(props.artwork_id, props.name, props.formik.values[props.name])
